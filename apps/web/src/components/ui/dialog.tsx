...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="hit-target absolute right-4 top-4 flex items-center justify-center rounded-[var(--radius-sm)] opacity-70 transition-opacity duration-[var(--duration-fast)] hover:opacity-100 disabled:pointer-events-none">
        <X className="h-4 w-4" />
